            ...
            <div class="card quiz-card">
                <div class="card-body">
                    <div class="quiz-header text-center mb-4">
                        <h2 class="mb-3" style="color: #8C2711">Quiz Général</h2>
                        <div class="quiz-info">
                    ...
                    <div class="quiz-content">
                        <form id="quiz-form">
                            ...
                            <div class="question-container mb-4">
                                <h5 class="question-text mb-3">1. Quelle est la capitale du Togo ?</h5>
                                <div class="options">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="q1" id="q1a" value="a">
                                        <label class="form-check-label" for="q1a">Lomé</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="q1" id="q1b" value="b">
                                        <label class="form-check-label" for="q1b">Kara</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="q1" id="q1c" value="c">
                                        <label class="form-check-label" for="q1c">Sokodé</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="q1" id="q1d" value="d">
                                        <label class="form-check-label" for="q1d">Atakpamé</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Question 2 -->
                            <div class="question-container mb-4">
                                <h5 class="question-text mb-3">2. Quel est le plus grand océan du monde ?</h5>
                                <div class="options">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="q2" id="q2a" value="a">
                                        <label class="form-check-label" for="q2a">Océan Pacifique</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="q2" id="q2b" value="b">
                                        <label class="form-check-label" for="q2b">Océan Atlantique</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="q2" id="q2c" value="c">
                                        <label class="form-check-label" for="q2c">Océan Indien</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="q2" id="q2d" value="d">
                                        <label class="form-check-label" for="q2d">Océan Arctique</label>
                                    </div>
                                </div>
                            </div>
